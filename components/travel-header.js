...
import { TravelNotification } from "./travel-notification.js";
...
export class TravelHeader extends HTMLElement {
    ...
    shadowRoot.innerHTML = /*html*/ `
      ...
      <header>
        ...
        <div id="header-right">
          ...
          <button id="connect-toggle"></button>
        </div>
      </header>
  ...
  async connectedCallback() {
    ...
    this.#renderToggle();
    this.shadowRoot.querySelector("#connect-toggle").addEventListener("click", () => this.toggleConnect());
  }

  #renderToggle() {
    this.shadowRoot.querySelector("#connect-toggle").innerHTML = this.#config.offline
